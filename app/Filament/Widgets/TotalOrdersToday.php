...
class TotalOrdersToday extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            ->extraAttributes([
                'class' => '!dark:bg-gradient-to-t from-lime-500 to-lime-950 hover:scale-105 duration-300'
            ]),
            ...
            Stat::make('Total earnings this month', 'रु ' . Order::whereMonth('created_at', Carbon::now()->month)->whereIn('status', ['ready', 'delivered', 'completed'])->sum('total_amount'))
            ->extraAttributes([
                'class' => 'bg-gradient-to-t from-amber-500 to-amber-950 hover:scale-105 duration-300'
            ]),
            Stat::make('Total earnings Today', 'रु ' . Order::whereDate('created_at', Carbon::today())->whereIn('status', ['ready', 'delivered', 'completed'])->sum('total_amount'))
            ->extraAttributes([
