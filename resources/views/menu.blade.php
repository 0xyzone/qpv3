                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="menu-item bg-white rounded-4xl shadow-lg overflow-hidden border border-violet-200 hover:shadow-xl transition-shadow duration-300 flex flex-col">
                            <div class="relative w-full h-48">
                                <img src="{{ $item->photo_path ? asset('storage/' . $item->photo_path) : asset('img/Food placements.png') }}" alt="{{ $item->name }}" class="absolute inset-0 w-full h-full aspect-video object-cover">
                            </div>
