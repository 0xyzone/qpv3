<section class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            <h2 class="text-lg md:text-3xl font-bold text-stone-800">Our <span class="text-violet-700">Popular</span> Items</h2>
            <p class="text-stone-500 text-xs md:text-sm pr-4 md:pr-0">Explore our delicious offerings crafted with care and passion.</p>
        </div>
        <a href="{{ route('menu') }}" class="bg-violet-700 p-4 rounded-full text-white lg:text-lg text-xs shrink-0">View All <svg class="w-6 h-6 md:w-8 md:h-8 p-2 rounded-full ml-2 inline bg-white " fill="#333" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg></a>
    </div>
